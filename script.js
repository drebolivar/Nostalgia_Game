...
function createBoard() {
  for (let i = 0; i < cardArray.length; i++) {
    ...
    card.setAttribute('src', 'resources/staticcard4.png')
...
function checkMatch() {
  ...
  if (tempCards[0] == tempCards[1]) {
    ...
    cards[firstCard].setAttribute('src', 'resources/staticcard4.png')
    cards[secondCard].setAttribute('src', 'resources/staticcard4.png')
